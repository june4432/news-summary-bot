...
from batch.common.config import newsletter_url 
...
<div style="font-family: 'Segoe UI', 'Noto Sans KR', sans-serif; font-size: 14px; color: #333; line-height: 1.6;">
  ...
  <p style="margin: 0 0 20px 0;">
    카테고리별로 최근 뉴스 10개를 요약했어요.<br>
    세상의 흐름을 빠르게 읽어보세요. 🌍
  </p>
  <p>텔레그램으로도 뉴스레터를 받아볼 수 있습니다. </br>👉 <a href="https://t.me/news_epitome_bot" target="_blank" style="color: #1a73e8; text-decoration: none;">텔레그램 열기</a></p>
</div>
"""
    ...
    token = generate_token(unsubscribe_email, is_email=True)
